package com.argroupcrm.crm.generic.crud.model.specification;

import com.argroupcrm.crm.generic.crud.model.specification.request.FilterRequest;
import com.argroupcrm.crm.generic.crud.model.specification.request.SearchRequest;
import com.argroupcrm.crm.generic.crud.model.specification.request.SortRequest;
...
public class SearchSpecification<T> implements Specification<T> {
    ...
    public static Pageable getPageable(Integer page, Integer size) {
        return PageRequest.of(Objects.requireNonNullElse(page, 1), Objects.requireNonNullElse(size, 10));
    }
