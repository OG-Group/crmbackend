...
/**
 * A DTO for the {@link com.argroupcrm.crm.model.cian.OfficeCianEntity} entity
 */
@Data
@Builder
@AllArgsConstructor
public class OfficeCianEntityDto implements Serializable {
    ...
    private final List<List<PhoneJson>> mainPhoneSchemaCountryCode;
    ...
    private final List<List<HighwayJson>> mainUndegroundsSchema;
    ...
    private final String furniturePresence;
    private final String availableFrom;
    private final Boolean isLegalAddressProvided;
    private final String waterPipesCount;
    private final String taxNumber;
    private final Boolean isInHiddenBase;
    private final String buisnessShoppingCenterId;
